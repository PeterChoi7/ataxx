...
class Move {
    ...
    /** Array for extend. */
    static final ArrayList EXTENDMOVE =
            new ArrayList(Arrays.asList(1, 10, 11, 12));

    /** Array for jump. */
    static final ArrayList JUMPMOVE =
            new ArrayList(Arrays.asList(24, 23, 22, 21, 20, 13, 9, 2));
    ...
    boolean isExtend() {
        if (EXTENDMOVE.contains(abs(fromIndex() - toIndex()))) {
            _isExtend = true;
        }
        return _isExtend;
    }
    ...
    boolean isJump() {
        if (JUMPMOVE.contains(abs(fromIndex() - toIndex()))) {
            _isJump = true;
        }
        return _isJump;
    }
    ...
    public String toString() {
        if (isPass()) {
            ...
            String col0 = String.valueOf(col0());
